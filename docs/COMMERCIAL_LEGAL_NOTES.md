...
## INVIMA and Colombian open data

Preliminary conclusion: a commercial product appears possible if it respects public-information and open-data reuse conditions.

Operational requirements:

- preserve attribution for INVIMA, UNIRS and POS Populi;
- show retrieval or import date when the data model supports it;
- do not imply endorsement, certification or partnership with INVIMA, Ministerio de Salud or another public institution;
- do not alter official regulatory meaning;
- separate regulatory indication from scientific literature and local clinical interpretation;
- keep the application as informational decision support unless formally evaluated for additional regulatory obligations;
- avoid CAPTCHA bypass or circumvention of access controls;
